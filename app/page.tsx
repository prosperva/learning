...
import { useDemoSearchFields } from './fieldConfigs/demoSearchFields';
import {
  Container,
  Typography,
  Box,
...
export default function Home() {
  ...
  // Field configs loaded from dedicated file (uses React Query for API-driven options)
  const { searchFields, accordionField } = useDemoSearchFields();
  const searchFieldsWithAccordion = useMemo(() => [...searchFields, accordionField], [searchFields, accordionField]);
